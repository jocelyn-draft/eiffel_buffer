note
	description: "Summary description for {UTF8_FILTER_ON_CHARACTER_8_OUTPUT_BUFFER}."
	date: "$Date: 2012-10-26 10:37:48 +0200 (ven., 26 oct. 2012) $"
	revision: "$Revision: 89683 $"

class
	UTF8_FILTER_ON_CHARACTER_8_OUTPUT_BUFFER

inherit
	FILTER_ON_CHARACTER_8_OUTPUT_BUFFER
