note
	description: "Summary description for {FILE_INPUT_BUFFER}."
	date: "$Date: 2012-11-18 22:51:53 +0100 (dim., 18 nov. 2012) $"
	revision: "$Revision: 89944 $"

class
	FILE_INPUT_BUFFER

inherit
	CHARACTER_8_INPUT_BUFFER
...
feature {NONE} -- Implementation
	...
	source: FILE
			-- Source for the BUFFER

	is_inner_source: BOOLEAN
			-- Is source created by the BUFFER?
